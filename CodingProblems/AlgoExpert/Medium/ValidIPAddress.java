...
For example, "192.168.0.1" is valid IP address, but "192.168.00.1" and "192.168.0.01"
aren't, because they contain "00" and 01, respectively. Another example of a valid IP address is
"99.1.1.10"; conversely, "991.1.1.0" isn't valid, because "991" is greater than 255.
...
class Program {
  ...
  public ArrayList<String> validIPAddresses(String s) {
