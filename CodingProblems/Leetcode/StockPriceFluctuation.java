...
*/
class StockPrice {
    private TreeMap<Integer,Integer> time2Price;
    private TreeMap<Integer,Integer> price2Count;
    public StockPrice() {
        time2Price = new TreeMap<>();
    ...
    public int current() {
        return time2Price.get(time2Price.lastKey());
    }
